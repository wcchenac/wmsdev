...
class AddClothInfo extends Component {
  ...
  onChange(e) {
    ...
    switch (name) {
      case "productNo":
        errors.productNo = value.quantity < 1 ? "貨號不可空白" : "";
        break;
      case "lotNo":
        errors.lotNo = value.quantity < 1 ? "批號不可空白" : "";
        break;
      case "quantity":
        errors.quantity = value.quantity < 1 ? "數量不可空白" : "";
        break;
      default:
        break;
    }
          ...
          <div className="row">
            <div className="col-md-6 m-auto">
              ...
              <form onSubmit={this.onSubmit}>
                ...
                <button
                  type="submit"
                  disabled={!this.state.productNo || !this.state.quantity}
...
export default connect(mapStateToProps, { createClothInfo })(AddClothInfo);
