...
class CustomerReturnBoard extends Component {
  constructor() {
    super();
    this.state = {
      isLoading: false,
  ...
  handleQueryOrderSubmit(e) {
    ...
    this.setState({ isLoading: true }, () => {
      this.props.getCustomerReturnOrder(this.state.orderNo).then(response => {
...
CustomerReturnBoard.propTypes = {
  queryReturnOrderResult: PropTypes.object.isRequired,
  getCustomerReturnOrder: PropTypes.func.isRequired,
